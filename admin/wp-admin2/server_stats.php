...
$total_movies = mysql_num_rows( mysql_query( "SELECT * FROM movies" ) );
...
<div id="moviectrl">
  ...
  <div>
    ...
    <p>There are <?php echo ( mysql_num_rows( mysql_query( "SELECT * FROM movies WHERE have_details = 'Y'" ) ) ); ?> movies total.</p>
  ...
  <div>
    ...
    <?php include "http://user:m0v13r4ck@testing1.vtnoc.net/iptv/drive_stats.php"; ?>
  </div>
</div>
