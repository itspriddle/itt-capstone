...
if ( defined('ABSPATH') )
    ...
    require_once('/home/priddle/www/admin/wp-config-2.php');

if ( get_option('db_version') != $wp_db_version )
	die (sprintf(__("Your database is out-of-date.  Please <a href='%s'>upgrade</a>."), get_option('siteurl') . '/wp-admin2/upgrade.php'));
    
require_once(ABSPATH . 'wp-admin2/admin-functions.php');
require_once(ABSPATH . 'wp-admin2/admin-db.php');
require_once(ABSPATH . 'wp-includes2/registration-functions.php');
...
require(ABSPATH . '/wp-admin2/menu.php');
...
if (isset($_GET['page'])) {
	...
	if ( $page_hook ) {
		if (! isset($_GET['noheader']))
			require_once(ABSPATH . '/wp-admin2/admin-header.php');
