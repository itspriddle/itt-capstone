...
<?php } ?>
<script type="text/javascript" src="edit-movies.js"></script>
<?php if ( $dbx_js ) { ?>
...
<body>
<div id="wphead">
<h1><?php echo wptexturize(get_settings(('blogname')). " Administration" ); ?> <!--<span>(<a href="http://movierack.nevercraft.net/"><?php _e('View site') ?> &raquo;</a>)</span>--></h1>
</div>
