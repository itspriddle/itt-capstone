...
<fieldset class="options">
    <legend><?php _e('Link Information') ?></legend>
    <p>URL is the web address for a particular link.</p>
    <p>Link Name is the text that will make up the link.</p>
        <table class="editform" width="100%" cellspacing="2" cellpadding="5">
         <tr>
           <th width="33%" scope="row"><?php _e('URL: (http://)') ?></th>
