...
function wp_mail($to, $subject, $message, $headers = '') {
	if( $headers == '' ) {
		$headers = "MIME-Version: 1.0\n" .
			"From: noreply@" . preg_replace('#^www\.#', '', strtolower($_SERVER['SERVER_NAME'])) . "\n" . 
...
function wp_new_user_notification($user_id, $plaintext_pass = '') {
	...
	$message  = sprintf(__('New user registration on %s:'), get_settings('blogname')) . "\r\n\r\n";
	...
	$message  = "Welcome to Movierack!\r\n\r\n";
	$message .= "\tYour username and password are below.  Enjoy Movierack Beta.\r\n";
	$message .= sprintf(__('Username: %s'), $user_login) . "\r\n";
	$message .= sprintf(__('Password: %s'), $plaintext_pass) . "\r\n\r\n";
	$message .= "http://movierack.net/\r\n";
		
	wp_mail($user_email, sprintf(__('[%s.net] Your username and password'), get_settings('blogname')), $message);
