...
/*		array (
	...
	$cfg['ilibs_dir'] 	   = array('/images/page_images/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	$cfg['base_url'] 	= 'http://inglenookrealtyinc.com/'; 							// base url; e.g. 'http://localhost/'	
