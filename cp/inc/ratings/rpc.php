...
$newtotals = mysql_query("SELECT total_votes, total_value, used_ips FROM mr_movie_ratings WHERE movie_id='$id_sent' ")or die(" Error: ".mysql_error());
...
"</ul>".
"<!--<p class=\"voted\"><strong> Rating: </strong>".@number_format($sum/$added,1)."/".$units." (".$count." ".$tense." cast) ".
